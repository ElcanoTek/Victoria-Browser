...
@@ -112,7 +112,12 @@ void RegisterBrowserUserPrefs(user_prefs::PrefRegistrySyncable* registry) {

-  registry->RegisterBooleanPref(prefs::kHomePageIsNewTabPage, true,
+  // Victoria: homepage defaults to home.elcanotek.com, not the new-tab page.
...
+                               "https://home.elcanotek.com",
+                               pref_registration_flags);
   registry->RegisterBooleanPref(prefs::kSplitViewDragAndDropEnabled, true,
                                 pref_registration_flags);
@@ -121,7 +126,8 @@ void RegisterBrowserUserPrefs(user_prefs::PrefRegistrySyncable* registry) {
                                 pref_registration_flags);
